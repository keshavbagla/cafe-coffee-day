package com.example.Cosmora.ui.theme
...
val CosmoraGreen = Color(0xFF25623F)
val CosmoraLightGreen = Color(0xFF4CAF50)
val CosmoraWhite = Color(0xFFFFFFFF)
val CosmoraBlack = Color(0xFF161616)
