...
import com.example.Cosmora.screens.PaymentScreen
import com.example.Cosmora.screens.SuccessSplashScreen
            ...
            MultiplepagesTheme {
                ...
                Surface(color = MaterialTheme.colorScheme.background) {
                    NavHost(navController = navController, startDestination = "home") {
                        ...
                        composable("CoffeeAppScreen") {
                            CosmoraCoffeeScreen(
                                navController = navController,
                                onGetStartedClick = {
                                    navController.navigate("CoffeeMainScreen")
                                }
                            )
                        }

                        composable("CoffeeMainScreen") {
                            CoffeeMainScreen(navController = navController)
                        }
                        ...
                        composable("payment_type") {
                            PaymentTypeScreen(navController = navController)
                        }
