...
fun LoginScreen(
    ...
    LaunchedEffect(savedEmail, savedPassword, isRememberMeChecked) {
        if (isRememberMeChecked && savedEmail.isNotEmpty()) {
            email = savedEmail
            ...
            onClick = {
                ...
                when {
                    ...
                    password == "admin123" -> {
                        ...
                        // Regular user login - now passing all 3 parameters
                        try {
